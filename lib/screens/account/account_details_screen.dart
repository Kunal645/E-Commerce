                  ...
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    if(snapshot.hasData){
                      Future.microtask(() async {
                        await controller.getUserDetails(UserModel.fromJson(snapshot.data!.docs[0].data() as Map<String,dynamic>));
                      });
                      return Obx(() {
                          return Column(
                            children: [
                              SizedBox(height: 45.h,),
                              Text("${controller.user.value.name?.firstname.toString().capitalizeFirst} ${controller.user.value.name?.lastname.toString().capitalizeFirst}",style: TextStyles.k16Bold(),),
                              SizedBox(height: 10.h,),
                              const Divider(),
                              SizedBox(height: 10.h,),
                              Card(
                              ...
                              SizedBox(height: 10.h,),
                              ElevatedButton(onPressed: () => Get.offAll(() => LoginScreen()), child: Text("Logout"))
                            ],
                          );
                        }
                      );

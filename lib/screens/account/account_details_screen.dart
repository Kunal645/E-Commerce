                      ...
                      return GestureDetector(
                        onTap: (){
                          if(controller.user.value.profilePic != null &&  controller.user.value.profilePic!.isNotEmpty){
                            Get.to(() => FullScreenPhotoView(file: File(controller.user.value.profilePic.toString())));
                          }
                          else{
                        ...
                        child: Container(
                          ...
                          ? ClipRRect(
                            ...
                            child: Image.file(File(controller.user.value.profilePic.toString()), fit: BoxFit.cover,),
                          )
                              : Container(),
                        ),
                      );
